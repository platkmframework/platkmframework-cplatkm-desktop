 ...
 */
public class JComboBoxComponentInspector extends ComponentInspector<JComboBox> {

    public JComboBoxComponentInspector(JComboBox jComponent, Object lastComponentValue) {
    ...
    public void isValueChanged(){
        this.valueUpdated = (jComponent.getSelectedItem() == lastComponentValue);
        runnable.run();
    }
