 ...
 */
public class JTextAreaEditorComponentInspector extends ComponentInspector<JTextArea> {

    public JTextAreaEditorComponentInspector(JTextArea jComponent, Object lastComponentValue) {
