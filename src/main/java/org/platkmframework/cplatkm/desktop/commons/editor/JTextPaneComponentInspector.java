 ...
 */
public class JTextPaneComponentInspector extends ComponentInspector<JTextPane> {

    public JTextPaneComponentInspector(JTextPane jComponent, Object lastComponentValue) {
