 ...
 */
public class ArtifactEditorPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ArtifactEditorPanel
     */
    public ArtifactEditorPanel() {
        initComponents();
        initCustomComponent();
    ...
    private void initComponents() {
        ...
        txtFolderName.setEnabled(false);
    ...
    private void btnApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyActionPerformed
        ...
        this.item.setTags(txtTags.getText().trim());
    ...
    public void setData(Artifact item) {
        
        tableModel.setRowCount(0); 
        artProperties = new ArrayList<>();
        this.item = item;
        if(item == null) this.item = new Artifact();
        
        txtName.setText(this.item.getLabel()); 
        txtFolderName.setText(this.item.getFoldername());
        txtTags.setText(this.item.getTags()); 
    ...
    public void setItem(Artifact item) {
        this.item = item;
    }
    ...
    private void initEditorComponetInspector() {
        ...
        components.add(new JTextEditorComponentInspector(txtTags, null)); 
